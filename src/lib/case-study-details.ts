...
const homeStorage: CaseStudyDetail = {
  ...
  inputs: [
    ...
    '现有商品图、参考图、品牌语气和禁用表达',
    'TikTok / Instagram / Amazon benchmark 链接',
    '负责人验收口径: 哪些能直接上架, 哪些必须人工终审',
  ],
  deliverables: [
    'SKU 简报与资料缺口表',
    '主图方向、详情页卖点顺序和合规提醒',
    'TikTok / Instagram benchmark 拆解表',
    '客服高频问答与人工终审 checklist',
    'POC 验收报告和下一轮 SKU 决策',
  ],
  beforeAfter: [
    { label: '资料输入', before: 'SKU、图、benchmark 分散在表格和聊天记录里', after: '统一成 SKU 简报、资料缺口、验收字段' },
    { label: '上新判断', before: '运营凭经验判断先做哪些 SKU', after: '按平台、素材、benchmark、合规风险排序' },
    { label: '复盘动作', before: '交付后只说看起来不错', after: '明确继续迭代、扩 SKU、推合同或停止推进' },
  ],
  review: {
    readiness: '线索可进 POC, 但复盘前必须补齐审核人和禁用词边界。',
    acceptanceScore: '82/100',
    decision: '扩 SKU',
    nextStep: '补齐禁用词清单后, 把胜出 Hook 和主图方向扩到下一批 20 SKU。',
    contractAction: '若下一批验收分超过 85, 推进主站长期上新合同。',
  },
  risks: [
    '食品接触、儿童用品、功效承诺等表达必须由客户终审。',
    'benchmark 只能支撑内容假设, 不能直接当作投放结论。',
    'AI 图和 AI 文案进入上架前需要人工抽检。',
  ],
  samples: [
    { label: '标题候选', body: 'Stackable Airtight Storage Bins, 6-Pack, BPA-Free PP, 3 Sizes, Save Cabinet Space' },
    { label: '主图方向', body: '白底 45 度主体图 + 厨房台面场景图 + 材质细节图 + 尺寸对比图。' },
    { label: '合规提醒', body: '检查 FDA 21 CFR、LFGB、Prop 65、REACH SVHC, 禁止未经验证的食品安全绝对化表述。' },
  ],
  timeline: [
    { label: '01 输入', body: '收集 SKU、平台、素材和 benchmark, 自动暴露缺口。' },
    { label: '02 标准包', body: '生成上新 SOP 包, 输出准入分、阻塞项和交付目录。' },
    { label: '03 交付', body: '进入新 listing、主图、客服话术或内容测试流水线。' },
    { label: '04 复盘', body: '按验收分决定扩 SKU、补资料、推合同或停跑。' },
  ],
  standardPackHref: standardPackHref({
    goal: '为家居收纳 10 SKU 生成上新 POC 标准交付包',
    brand: '家居收纳 / 10 SKU POC / Shopify + TikTok Shop',
    sku: '收纳盒、密封罐、厨房整理、柜门挂架等 10 个 SKU, 目标是验证上新资料、主图方向、详情页卖点、合规边界和复盘决策。',
    links: '参考 TikTok 家居整理视频、Instagram 家居账号和 Amazon 同类 listing, 仅用于 benchmark 拆解。',
  }),
};

const autoAccessory: CaseStudyDetail = {
  slug: 'auto-parts',
  title: '汽摩配件 Benchmark-to-Campaign Pack',
  segment: '车载配件 / Amazon + 独立站 / 内容营销 POC',
  category: '汽摩配件',
  summary: '把车型兼容、安装场景、商标边界和内容首帧假设放进同一套可验收 POC。',
  scenario: '客户要上新车载支架和收纳配件, 最大风险不是文案不够好, 而是车型兼容、第三方商标和安装场景说不清。',
  pipelineLabel: 'Pipeline 01 · 新品上新 + 市场宣传包',
  pipelineHref: '/pipelines/marketing-campaign',
  proofLevel: '匿名样例, 展示 benchmark 如何变成交付目录',
  ...
  inputs: [
    ...
    'Amazon listing、Instagram Reels 和用户评论痛点',
    '第三方商标引用边界和人工终审责任人',
  ],
  deliverables: [
    '兼容车型描述结构',
  ...
  beforeAfter: [
    ...
    { label: '内容脚本', before: '只写卖点, 没有安装场景和反对意见', after: '从评论痛点拆 Hook、场景、反驳和 CTA' },
    { label: '合同推进', before: '客户只看单次文案质量', after: '用复盘判断是否扩到全车品线' },
  ],
  review: {
    readiness: '可以进入 POC, 复盘重点放在兼容说明、安装场景和内容首帧。',
    acceptanceScore: '84/100',
    decision: '推进主站合同',
    nextStep: '把兼容说明模板、合规词库和内容测试包纳入主站长期交付。',
    contractAction: '用 POC 报告换长期上新 + 内容营销月包, 不单卖散文案。',
  },
  risks: [
    '车型兼容清单需要客户负责人确认。',
  ...
  samples: [
    { label: '兼容结构', body: '2018-2024 Toyota Camry / RAV4, 2019-2024 Honda Civic / CR-V, 2020-2024 Tesla Model 3 / Y。' },
    { label: '内容 Hook', body: '3 秒内展示单手安装失败场景, 再切到磁吸固定和转弯稳定对比。' },
    { label: '合规边界', body: '避免 Apple Compatible 等高风险表达, 改为 Works with MagSafe devices 并保留人工终审。' },
  ],
  timeline: [
    { label: '01 输入', body: '导入车型、参数、安装方式和 benchmark。' },
    { label: '02 标准包', body: '生成兼容说明、合规词边界和内容测试目录。' },
    { label: '03 交付', body: '进入 listing、Reels 脚本和客服问答生产。' },
    { label: '04 复盘', body: '用验收分判断是否进入长期车品线合同。' },
  ],
  standardPackHref: standardPackHref({
    goal: '为汽摩配件 SKU 生成 benchmark-to-campaign POC 标准交付包',
    brand: '汽摩配件 / Amazon + 独立站 / 内容营销 POC',
    sku: '车载支架、车载收纳、磁吸配件等 8 个 SKU, 重点验证车型兼容、安装场景、商标边界和内容首帧。',
    links: 'Amazon 同类 listing、Instagram 安装演示、用户评论痛点, 仅用于拆解参考。',
  }),
};
...
const electronicsOutbound: CaseStudyDetail = {
  slug: 'electronics',
  title: '数码 SKU 外联增长包',
  segment: '数码电子 / TikTok + Instagram / 达人冷启 POC',
  category: '数码电子',
  ...
  proofLevel: '匿名样例, 展示外联 SOP 与复盘字段',
  ...
  beforeAfter: [
    ...
    { label: '外联文案', before: '复制模板群发, 容易被忽略', after: '每条引用对方近期内容, 保留品牌 CTA' },
    { label: '复盘', before: '只看有没有回复', after: '按开头、卖点、平台和达人层级归因' },
  ],
  review: {
    readiness: '可以继续迭代 POC, 但扩量前要补达人筛选口径和合作条款。',
    acceptanceScore: '76/100',
    decision: '继续迭代 POC',
    nextStep: '补齐达人筛选口径、合作条款和回复归因表, 再决定是否扩到完整外联包。',
    contractAction: '暂不推大合同, 先用第二轮 POC 验证回复质量与执行稳定性。',
  },
  risks: [
  ...
  samples: [
    { label: '邮件主题', body: 'Kayak x Micro 2: would your June trip need a waterproof speaker?' },
    { label: '个性化开头', body: 'Saw your BC 30-day kayak loop. The sunrise clip is exactly the outdoor context this SKU needs.' },
    { label: '跟进字段', body: '账号层级、内容主题、开头版本、CTA 版本、回复状态、下一步动作。' },
  ],
  timeline: [
    { label: '01 输入', body: '录入 SKU、预算、CTA 和达人清单。' },
    { label: '02 标准包', body: '生成外联 SOP、A/B 版本和跟进字段。' },
    { label: '03 交付', body: '导出到 Gmail YAMM、Mailmeteor 或人工执行表。' },
    { label: '04 复盘', body: '按回复归因决定扩量、换人群或停止。' },
  ],
  standardPackHref: standardPackHref({
    goal: '为数码 SKU 生成达人外联 POC 标准交付包',
    brand: '数码电子 / TikTok + Instagram / 达人冷启 POC',
...
const productImage: CaseStudyDetail = {
  slug: 'novahome-image',
  title: 'AI 电商主图候选包',
  segment: '家居用品 / Amazon + Shopify / 主图生产 POC',
  category: '家居用品 · 主图',
  summary: '把拍摄排期前置成候选图验证, 让运营先判断哪些 SKU 值得进入正式视觉生产。',
  scenario: '客户月均 30+ SKU 上新, 摄影棚排期慢。POC 先验证主图方向、场景图和终审边界。',
  pipelineLabel: 'Pipeline 03 · AI 电商主图',
  pipelineHref: '/pipelines/product-image',
  proofLevel: '匿名样例, 展示候选图生产与人工终审边界',
  disclaimer: 'AI 图只作为候选图和测试素材, 最终上架必须人工终审。',
  metrics: [
  ...
  review: {
    ...
    contractAction: '先卖视觉规范整理 + 10 SKU 候选图 POC, 通过后接长期视觉月包。',
  },
  risks: [
    'AI 图可能出现细节不一致, 必须人工终审。',
  ...
  timeline: [
    ...
    { label: '03 交付', body: '进入 AI 主图或摄影简报流水线。' },
    { label: '04 复盘', body: '按候选图验收决定正式拍摄或批量生成。' },
  ],
  standardPackHref: standardPackHref({
    goal: '为家居 SKU 生成 AI 主图候选 POC 标准交付包',
    brand: '家居用品 / Amazon + Shopify / 主图生产 POC',
    sku: '收纳盒系列 SKU, 需要主图、场景图、细节图和对比图候选方向, 最终上架人工终审。',
    links: '品牌视觉规范、平台图片规范和同类 listing 参考。',
  }),
};
...
const homelody: CaseStudyDetail = {
  ...
  slug: 'homelody',
  title: 'H 代运营家居上新样例',
  segment: '家居用品 / Amazon 多站点 / 新品上新 POC',
};
...
const vicseed: CaseStudyDetail = {
  ...
  slug: 'vicseed',
  title: 'V 独立站车载支架样例',
  segment: '汽摩配件 / Shopify + Amazon / 兼容说明 POC',
};
