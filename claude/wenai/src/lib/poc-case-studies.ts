...
export const POC_EVIDENCE_CASES: PocEvidenceCase[] = [
  {
    ...
    title: '匿名样例 A · 家居收纳 10 SKU Launch Pack',
    segment: '美区独立站 + TikTok Shop / 家居收纳 / 10 SKU POC',
    disclaimer: '匿名样例, 用于展示交付结构和复盘口径。不是客户业绩承诺, 不声明 GMV 或转化提升。',
    input: {
      ...
      benchmark: '3 条 TikTok 家居整理视频、2 个 Instagram 家居账号、1 个 Amazon 同类 listing。',
    },
    standardPack: {
      ...
      blockers: [
        '缺少最终审核人签字口径',
        '合规禁用词未整理',
        'benchmark 只能支撑内容假设, 还不能直接当作投放结论',
      ],
      decision: '可进入 POC, 但复盘前必须补齐审核人和禁用词边界。',
    },
    deliverables: [
      '10 SKU 输入简报与资料缺口表',
      '每个 SKU 的主图方向、详情页卖点顺序和合规提醒',
      'TikTok / Instagram benchmark 拆解表',
      'Slideshow 首帧测试假设与 7 天排期',
      '客服高频问答与人工终审 checklist',
      'POC 验收报告与下一轮 SKU 决策',
    ],
    beforeAfter: [
      { label: '输入资料', before: 'SKU、图、benchmark 分散在表格和聊天记录里', after: '统一成 SKU 简报、资料缺口、验收字段' },
      { label: '交付判断', before: '运营凭经验判断先做哪些 SKU', after: '按平台、素材、benchmark、合规风险排序' },
    ...
    evidence: [
      '每个 deliverable 都能对应到输入字段, 不靠临场口头解释。',
  ...
  },
  {
    ...
    title: '匿名样例 B · 汽摩配件 Benchmark-to-Campaign Pack',
    segment: 'Amazon + 独立站 / 车载配件 / 内容营销 POC',
    disclaimer: '匿名样例, 只展示方法和交付形态。竞品内容只做拆解参考, 不复制素材, 不承诺投放结果。',
    input: {
      skuScope: '8 个车载支架和收纳配件, 其中 5 个可进入完整内容测试。',
      platforms: 'Amazon listing + 独立站 landing page + Instagram Reels。',
      assets: '参数表齐, 但车型兼容、商标词、安装场景需要人工终审。',
      benchmark: 'Amazon 3 个同类 listing、Instagram 4 条安装演示内容、2 条用户评论痛点。',
    },
    standardPack: {
      ...
      decision: '可进入 POC, 复盘重点放在兼容说明、安装场景和内容首帧。',
    },
    deliverables: [
      '兼容车型描述结构',
      'Amazon 标题与五点描述候选',
