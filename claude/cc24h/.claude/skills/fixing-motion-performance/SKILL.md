...
description: "ALWAYS check after adding ANY animation, transition, or scroll effect. Verify 60fps, no layout thrashing, will-change usage, prefers-reduced-motion support. Use with motion-design skill."
---
